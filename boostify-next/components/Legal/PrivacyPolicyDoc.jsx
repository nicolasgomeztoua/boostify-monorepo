...
const PrivacyPolicyDoc = () => {
  return (
    <div style={{ textAlign: "center" }}>
      <h1>Privacy Policy for Boostify.es</h1>

      <p>
        At Boostify.es, accessible from Boostify.es, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by Boostify.es and
        how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Boostify.es. This policy is not applicable to
      ...
      <p>
        Boostify.es follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Boostify.es uses &apos;cookies&apos;. These
      ...
      <p>
        ...
        advertising partners of Boostify.es.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Boostify.es, which are sent
      ...
      <p>
        Note that Boostify.es has no access to or control over these cookies
      ...
      <p>
        Boostify.es&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Boostify.es does not knowingly collect any Personal Identifiable
