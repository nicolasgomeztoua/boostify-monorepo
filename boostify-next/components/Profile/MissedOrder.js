...
const MissedOrder = ({ userId }) => {
  ...
  return (
    <div>
      ...
      />
      ;
      <div className={generalStyles["missing-order-container"]}>
        <h2
        ...
        <p id="missing-order-desc" className={generalStyles["desc"]}>
          Simply input the order ID that you received in your order confirmation
          email in your PSN/XBOX&apos;s account email.
        </p>

        <div className={generalStyles["webflow-style-input"]} style={{ width: "80vw" }}>
          <input
            className={generalStyles["missing-order-input"]}
            type="email"
          ...
          <button
            type="submit"
            className={generalStyles["missing-order-btn"]}
